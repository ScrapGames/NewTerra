Shader "UI/Blur"
{
    ...
    SubShader
    {
		...
		HLSLINCLUDE
			#define SampleGrabTexture(posX, posY) tex2Dproj( _CameraOpaqueTexture, float4(i.screenPos.x + _CameraOpaqueTexture_TexelSize.x * posX, i.screenPos.y + _CameraOpaqueTexture_TexelSize.y * posY, i.screenPos.z, i.screenPos.w))
		ENDHLSL
